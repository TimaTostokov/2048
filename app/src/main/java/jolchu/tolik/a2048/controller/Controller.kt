package jolchu.tolik.a2048.controller
...
class Controller private constructor(private val context: Context) {
    ...
    private val mediaPlayer: MediaPlayer = MediaPlayer.create(context, R.raw.button_sound)
